...
const ProfilingRules = () => {
  ...
  const handleGenerateRules = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/get_validation_rules', {
        method: 'POST',
        body: formData
      });
...
    }, {});
    ...
    try {
      const res = await fetch('http://localhost:8000/api/regenerate_rules', {
        method: 'POST',
        body: formData
      });
  ...
  const handleRunValidation = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/run_validation', {
        method: 'POST',
        body: formData
      });
